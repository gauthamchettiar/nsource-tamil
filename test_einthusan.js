/**
 * Einthusan Provider Test
 *
 * Usage:
 *   node test_einthusan.js [tmdbId] [mediaType] [season] [episode]
 *
 * Example:
 *   node test_einthusan.js 19995 movie   (Avatar)
 */

const { getStreams } = require('./src/providers/einthusan.js');

async function test() {
    console.log("Starting Einthusan test...");

/**
 * AllMovieLand Provider Test
 *
 * Usage:
 *   node test_allmovieland.js [tmdbId] [mediaType] [season] [episode]
 *
 * Example:
 *   node test_allmovieland.js 19995 movie   (Avatar)
 */

const { getStreams } = require('./src/providers/allmovieland.js');

async function test() {
    console.log("Starting AllMovieLand test...");

/**
 * TamilGun Provider Test
 *
 * Usage:
 *   node test_tamilgun.js [tmdbId] [mediaType]
 *
 * Example:
 *   node test_tamilgun.js 937020 movie   (Jailer)
 */

const { getStreams } = require('./src/providers/tamilgun.js');

async function test() {
    console.log("Starting TamilGun test...");

/**
 * ZinkMovies Provider Test
 *
 * Usage:
 *   node test_zinkmovies.js [tmdbId] [mediaType] [season] [episode]
 *
 * Example:
 *   node test_zinkmovies.js 19995 movie   (Avatar)
 */

const { getStreams } = require('./src/providers/zinkmovies.js');

async function test() {
    console.log("Starting ZinkMovies test...");
